...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (themeToggleBtn) {
    ...
    themeToggleBtn.addEventListener('click', () => {
      ...
      themeToggleBtn.innerHTML = `<i class="fa ${isDark ? 'fa-sun' : 'fa-moon'}"></i>`;
    });
  }
  ...
  (async function loadHome() {
    ...
    if (heroSlidesEl) {
      ...
      if (heroes.length > 0) {
        slidesMarkup = heroes.map((h, i) => `
          <div class="swiper-slide">
            <img src="${resolveImg(h.imageUrl)}" alt="${h.title || 'Alankar Jewellers'}">
            <div class="hero-overlay"></div>
            <div class="hero-content">
              <span class="hero-tag">Alankar Jewellers</span>
              <h1>${h.title || 'Crafting Timeless Elegance'}</h1>
              <p>${h.subtitle || 'Exquisite handcrafted jewellery — BIS hallmarked & certified since 1995'}</p>
              <div class="hero-cta">
                <a href="${h.link || 'shop.html'}" class="btn"><i class="fa fa-gem"></i> Shop Now</a>
                <a href="about.html" class="btn btn-outline">Our Story</a>
              </div>
            </div>
          </div>`);
        slidesMarkup = slidesMarkup.join('');
      } else {
        const heroData = [
          { src: 'images/hero-1.jpg', title: 'Timeless Elegance', subtitle: 'Discover our fine jewellery collection' },
          { src: 'images/hero-2.jpg', title: 'Crafted with Love', subtitle: 'BIS 916 hallmarked gold & diamond jewellery' },
          { src: 'images/hero-3.jpg', title: 'For Every Occasion', subtitle: 'Bridal, festive and everyday collections' },
        ];
        slidesMarkup = heroData.map(d => `
          <div class="swiper-slide">
            ...
            <div class="hero-content">
              ...
              <p>${d.subtitle}</p>
              <div class="hero-cta">
                <a href="shop.html" class="btn"><i class="fa fa-gem"></i> Shop Now</a>
                <a href="about.html" class="btn btn-outline">Our Story</a>
              </div>
            </div>
          </div>`).join('');
...
/* ============================================================
   ...
   ============================================================ */
function initTheme() {
  // Theme is now handled by DOMContentLoaded listener above; nothing to do here
}
